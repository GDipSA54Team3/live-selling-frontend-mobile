...
public class ChannelProfileActivity extends AppCompatActivity implements IMenuAccess {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ChannelProfileActivity.this, android.R.style.Theme_DeviceDefault_Dialog, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        clock.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(ChannelProfileActivity.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
